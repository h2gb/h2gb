...
mod tests {
    ...
    use crate::sized_number::{GenericReader, SizedDisplay, Endian};
    ...
    fn test_action_create_entry() -> SimpleResult<()> {
        ...
        let datatype = H2Number::new(GenericReader::U32(Endian::Big), SizedDisplay::Decimal(Default::default()));
        ...
        let datatype = LPString::new(H2Number::new(GenericReader::U8, SizedDisplay::Decimal(Default::default())), ASCII::new(StrictASCII::Strict))?;
