...
pub fn commit_entry(record: &mut Record<Action>, buffer: &str, layer: &str, resolved_type: ResolvedType, origin: Option<impl Into<H2Type>>, comment: Option<&str>) -> SimpleResult<()> {
    // Save the offset
...
pub fn create_entry(record: &mut Record<Action>, buffer: &str, layer: &str, datatype: impl Into<H2Type>, offset: usize, comment: Option<&str>, data: &Data) -> SimpleResult<ResolvedType> {
    // Resolve the entry
...
pub fn create_entry_integer(record: &mut Record<Action>, buffer: &str, layer: &str, datatype: impl Into<H2Type>, offset: usize, comment: Option<&str>, data: &Data) -> SimpleResult<Integer> {
...
pub fn create_entry_string(record: &mut Record<Action>, buffer: &str, layer: &str, datatype: impl Into<H2Type>, offset: usize, comment: Option<&str>, data: &Data) -> SimpleResult<String> {
