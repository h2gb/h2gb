...
mod tests {
    ...
    fn test_ipv4() -> SimpleResult<()> {
        ...
        assert_eq!("127.0.0.1", IPv4::new(Endian::Big).to_display(context, &DataNg::default())?);
    ...
    fn test_ipv4_little() -> SimpleResult<()> {
        ...
        assert_eq!("4.2.2.1", IPv4::new(Endian::Little).to_display(context, &DataNg::default())?);
    ...
    fn test_ipv4_error() -> SimpleResult<()> {
        ...
        assert!(IPv4::new(Endian::Big).to_display(context, &DataNg::default()).is_err());
