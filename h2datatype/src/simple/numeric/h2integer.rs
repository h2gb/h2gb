...
mod tests {
    ...
    fn test_u8_hex() -> SimpleResult<()> {
        ...
        assert_eq!("0x00", t.to_display(context.at(0), &DataNg::default())?);
        assert_eq!("0x7f", t.to_display(context.at(1), &DataNg::default())?);
        assert_eq!("0x80", t.to_display(context.at(2), &DataNg::default())?);
        assert_eq!("0xff", t.to_display(context.at(3), &DataNg::default())?);
    ...
    fn test_i16_decimal() -> SimpleResult<()> {
        ...
        assert_eq!("0",      t.to_display(context.at(0), &DataNg::default())?);
        assert_eq!("32767",  t.to_display(context.at(2), &DataNg::default())?);
        assert_eq!("-32768", t.to_display(context.at(4), &DataNg::default())?);
        assert_eq!("-1",     t.to_display(context.at(6), &DataNg::default())?);
