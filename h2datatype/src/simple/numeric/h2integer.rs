...
use generic_number::{Integer, IntegerReader, GenericFormatter};
...
impl H2Integer {
    pub fn new_aligned(alignment: Alignment, reader: IntegerReader, display: GenericFormatter) -> H2Type {
    ...
    pub fn new(reader: IntegerReader, display: GenericFormatter) -> H2Type {
